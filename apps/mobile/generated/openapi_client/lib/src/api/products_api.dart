...
class ProductsApi {
  ...
  Future<Response<ProductListResponse>> v1ProductsGet({ 
    String? search,
    String? categoryId,
...
_responseData = rawData == null ? null : deserialize<ProductListResponse, ProductListResponse>(rawData, 'ProductListResponse', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductResponse>> v1ProductsPost({ 
...
_bodyData=jsonEncode(createProductRequest);
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ProductResponse, ProductResponse>(rawData, 'ProductResponse', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [ProductResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductResponse>> v1ProductsProductIdGet({ 
    ...
    final _path = r'/v1/products/{productId}'.replaceAll('{' r'productId' '}', productId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ProductResponse, ProductResponse>(rawData, 'ProductResponse', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProductUpdateResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductUpdateResponse>> v1ProductsProductIdPatch({ 
    required String productId,
...
_bodyData=jsonEncode(updateProductRequest);
    ...
    ProductUpdateResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ProductUpdateResponse, ProductUpdateResponse>(rawData, 'ProductUpdateResponse', growable: true);
    ...
    return Response<ProductUpdateResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
